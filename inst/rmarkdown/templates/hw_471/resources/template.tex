...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={$if(anonymous)$$else$$for(author)$$author.name$ ($author.pennkey$)$sep$ and $endfor$$endif$},
...
$if(anonymous)$\hfill $else$$for(author)$\textbf{\authorfont $author.name$} \hskip 15pt \emph{\small $author.pennkey$}  $sep$ \par $endfor$ $endif$
